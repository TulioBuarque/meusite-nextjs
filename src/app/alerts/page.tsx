...
const alertsData = [
  { id: 1, priority: 'high', status: 'active', pair: 'EUR/USD', condition: 'above', value: '1.0850', actions: ['edit', 'delete'] },
  { id: 2, priority: 'medium', status: 'active', pair: 'GBP/USD', condition: 'above', value: '1.2750', actions: ['edit', 'delete'] },
  { id: 3, priority: 'medium', status: 'active', pair: 'USD/JPY', condition: 'below', value: '150.00', actions: ['edit', 'delete'] },
  { id: 4, priority: 'high', status: 'active', pair: 'AUD/USD', condition: 'above', value: '0.6550', actions: ['edit', 'delete'] },
  { id: 5, priority: 'low', status: 'active', pair: 'USD/CAD', condition: 'below', value: '1.3500', actions: ['edit', 'delete'] },
  { id: 6, priority: 'low', status: 'inactive', pair: 'USD/CAD', condition: 'above', value: '1.3900', actions: ['edit', 'delete'] },
];
